...
function start()
    ...
    hold off;
    g = text(5,15,'Press any button to control.','color','y','FontSize',20);
    gg1 = text(5.05,15,'Press any button to control.','color','g','FontSize',20);
    gg =text(3.5,13,'Player 1 will use W & S keys to move and F key to fire.','color','b','FontSize',30);
    gg2 =text(3.51,13,'Player 1 will use W & S keys to move and F key to fire.','color','w','FontSize',30);
    mm =text(3.5,11.5,'Player 2 will use up and down arrow keys to move and left arrow key to fire','color','b','FontSize',30);
    mm1 =text(3.51,11.5,'Player 2 will use up and down arrow keys to move and left arrow key to fire','color','w','FontSize',30);
    waitforbuttonpress;
    delete(gg);
    delete(gg1);
    delete(gg2);
...
global w s u d B A Posi player_1 player_2 A0
